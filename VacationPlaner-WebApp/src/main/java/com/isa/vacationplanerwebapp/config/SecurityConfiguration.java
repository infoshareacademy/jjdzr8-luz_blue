    ...
    SecurityFilterChain web(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/", "/home", "/index/**","/static/**", "/css/**", "/assets/**", "/js/**", "/login/**").permitAll()
                .requestMatchers("/vacationList/**","/employeeList/**","/teamList/**","/vacationAdd/**").hasRole("USER")
                .requestMatchers("/vacationAdd/**","/vacationList/**","/vacationModify/**","/employeeAdd/**","/employeeModify/**","/teamModify/**","/teamAdd/**","/teamDelete/**","/teamModifySelectedTeam/**","/vacationDelete/**","/employeeDelete/**").hasRole("SUPERUSER")
